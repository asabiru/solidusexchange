...
CREATE TABLE `basic_controls` (
  ...
  `refund_exchange_status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '0=>inactive,1=>active',
  `refund_exchange_note` text DEFAULT NULL,
...
CREATE TABLE `buy_requests` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0=>initiate,1=>give_address,2=>deposit_amount,3=>exchange_completed,4=>time_expired,5=>cancel,6=>refund',
...
CREATE TABLE `exchange_requests` (
  ...
  `destination_wallet` varchar(255) DEFAULT NULL COMMENT 'which address crypto send',
  `refund_wallet` varchar(255) DEFAULT NULL COMMENT 'which address crypto refund',
...
(30, 1, 'Exchange Refund', 'EXCHANGE_REFUND', 'support@you.com', 'Your exchange has been refund', '{\"user\":\"User\",\"sendAmount\":\"Send Amount\",\"getAmount\":\"Get Amount\",\"sendCurrency\":\"Send Currency\",\"getCurrency\":\"Get Currency\",\"transaction\":\"Transaction\"}', '[[user]] your exchange request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your exchange request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your exchange request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your exchange request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '{\"mail\":\"1\",\"sms\":\"1\",\"in_app\":\"1\",\"push\":\"1\"}', 0, 'en', '2021-08-02 18:05:43', '2024-01-21 10:40:05'),
...
(33, 1, 'Crypto Buy Refund', 'BUY_REFUND', 'support@you.com', 'Your crypto buy request has been refunded', '{\"user\":\"User\",\"sendAmount\":\"Send Amount\",\"getAmount\":\"Get Amount\",\"sendCurrency\":\"Send Currency\",\"getCurrency\":\"Get Currency\",\"transaction\":\"Transaction\"}', '[[user]] your crypto buy request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your crypto buy request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your crypto buy request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your crypto buy request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '{\"mail\":\"1\",\"sms\":\"1\",\"in_app\":\"1\",\"push\":\"1\"}', 0, 'en', '2021-08-02 18:05:43', '2024-01-21 10:40:05'),
...
(36, 1, 'Crypto Sell Refund', 'SELL_REFUND', 'support@you.com', 'Your crypto sell request has been refunded', '{\"user\":\"User\",\"sendAmount\":\"Send Amount\",\"getAmount\":\"Get Amount\",\"sendCurrency\":\"Send Currency\",\"getCurrency\":\"Get Currency\",\"transaction\":\"Transaction\"}', '[[user]] your crypto sell request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your crypto sell request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your crypto sell request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '[[user]] your crypto sell request [[sendAmount]] [[sendCurrency]] to [[getAmount]] [[getCurrency]] has been refunded. Transaction Id- [[transaction]]', '{\"mail\":\"1\",\"sms\":\"1\",\"in_app\":\"1\",\"push\":\"1\"}', 0, 'en', '2021-08-02 18:05:43', '2024-01-21 10:40:05');
...
CREATE TABLE `sell_requests` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0=>initiate,1=>give_address,2=>deposit_amount,3=>exchange_completed,5=>cancel,6=>refund',
  `admin_wallet` text DEFAULT NULL COMMENT 'admin crypto wallet address',
  `refund_wallet` text DEFAULT NULL COMMENT 'crypto will be back this address',
