...
@section('page_title', __('Edit Support Agent'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Edit Agent')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Edit Support Agent')</h1>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.support.agents.update', $agent->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="username" class="form-control" value="{{ old('username', $agent->username) }}">
                                    @error('username')
                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="telegram_username" class="form-control"
                                           ...
                                           value="{{ old('telegram_username', $agent->telegram_username ? '@' . ltrim($agent->telegram_username, '@') : '') }}">
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch mb-3">
                                ...
                                <input class="form-check-input" type="checkbox" id="agentStatus" name="status" value="1"
                                       {{ (string) old('status', $agent->status) === '1' ? 'checked' : '' }}>
