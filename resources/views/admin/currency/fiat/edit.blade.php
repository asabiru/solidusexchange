                                ...
                                <form action="{{ route('admin.fiatEdit').'?id='.$currency->id }}" method="post"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.01" min="0" class="form-control" name="rate_markup_percent"
                                                           value="{{ old('rate_markup_percent', $currency->rate_markup_percent) }}"
                                        ...
                                        <div class="col-md-6">
                                              ...
                                              <span
                                                ...
                                                <span class="col-4 col-sm-3 text-end">
                                                    ...
                                                    <input
                                                        ...
                                                        {{ old('show_in_buy', (string) $currency->show_in_buy) === '1' ? 'checked' : '' }}>
                                                </span>
                                                @error('show_in_buy')
                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                                @enderror
                                              ...
                                              <span
                                                ...
                                                <span class="col-4 col-sm-3 text-end">
                                                    ...
                                                    <input
                                                        ...
                                                        {{ old('show_in_sell', (string) $currency->show_in_sell) === '1' ? 'checked' : '' }}>
                                                </span>
                                                @error('show_in_sell')
                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"
                                                       for="BuyGateway">@lang('Linked Buy Method')</label>
                                                <select class="form-select" name="buy_gateway_id" id="BuyGateway">
                                                    <option value="">@lang('No specific method')</option>
                                                    @foreach($paymentGateways as $paymentGateway)
                                                        <option value="{{ $paymentGateway->id }}" {{ old('buy_gateway_id', $currency->buy_gateway_id) == $paymentGateway->id ? 'selected' : '' }}>
                                                            {{ $paymentGateway->name }}
                                                            @if($paymentGateway->id >= 1000)
                                                                (@lang('Manual'))
                                                            @endif
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('buy_gateway_id')
                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                                @enderror
                                                <small class="text-body d-block mt-2">
                                                    @lang('If a method is selected, this fiat currency will use only that active buy method in the user flow. Manual gateways are also available here.')
                                                </small>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="fiat_send_gateway_id" id="FiatSendGateway">
                                                    ...
                                                    @foreach($fiatSendGateways as $fiatSendGateway)
                                                        <option value="{{ $fiatSendGateway->id }}" {{ old('fiat_send_gateway_id', $currency->fiat_send_gateway_id) == $fiatSendGateway->id ? 'selected' : '' }}>
