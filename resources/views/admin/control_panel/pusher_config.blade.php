        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div id="emailSection" class="card mb-4">
                    ...
                    <div class="card-body">
                        @lang("Pusher Channels provides realtime communication between servers, apps and devices. When something happens in your system, it can update web-pages, apps and devices. When an event happens in an app, the app can notify all other apps and your system.")
                        <br><br>
                        ...
                        @lang("Then create a Channels app. Open its Keys page and save your app_id, key, secret, and cluster.")
                    </div>
                </div>
            </div>
        </div>
