            ...
            <div class="col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>@lang('Current webhook endpoint:') <code>{{ route('sumsub.webhook') }}</code></p>
                        <p>@lang('After moving the project to the server, update Sumsub webhook URL and allowed origin there.')</p>
                    </div>
                </div>
            </div>
        </div>
