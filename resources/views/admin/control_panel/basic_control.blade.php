                                                ...
                                                <label class="form-control"
                                                       for="editUserModalAccountTypeModalRadioEg1_1">
                                                        <span class="form-check">
                                                          <input type="radio" class="form-check-input default_theme"
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <h5 class="mb-0">@lang('Change theme Mode Icon')</h5>
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('this allow to user change visual mode theme on your website.')</span>
                                                </div>
                                                <div class="col-auto">
                                                    <label class="row form-check form-switch" for="changeable_mode">
                                                <span class="col-4 col-sm-3 text-end">
                                                    <input type='hidden' value='0' name='changeable_mode'>
                                                        <input
                                                            class="form-check-input @error('changeable_mode') is-invalid @enderror"
                                                            type="checkbox"
                                                            name="changeable_mode"
                                                            id="changeable_mode"
                                                            value="1" {{($basicControl->changeable_mode == "1") ? 'checked' : ''}}>
                                                    </span>
                                                        @error('changeable_mode')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                        @enderror
                                                    </label>
