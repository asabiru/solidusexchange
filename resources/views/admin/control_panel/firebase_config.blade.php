        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div id="emailSection" class="card my-4">
                    ...
                    <div class="card-body">
                        @lang("Push notifications provide realtime communication between servers, apps, and devices. When something happens in your system, it can update web pages, apps, and devices. When an event happens in an app, it can notify all other apps and your system.")
                        <br><br>
                        @lang("Get your free API keys")
                        <a href="https://console.firebase.google.com/"
                           target="_blank">@lang('Create an account') <i class="fas fa-external-link-alt"></i>
                        </a>
                        @lang("Then create a Firebase project and a web app inside it. Open the web app configuration to get the Vapid key, Api key, Auth domain, Project id, Storage bucket, Messaging sender id, App id, and Measurement id.")
                    </div>
                </div>
            </div>
        </div>
