                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.logo.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        <label class="col-form-label">@lang('Light Theme Logo')</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="col-form-label">@lang('Dark Theme Logo')</label>
                                        <label class="form-check form-check-dashed darkLogoUploader" for="darkLogoUploader">
                                            <img id="darkLogoImg"
                                                 class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2 object-fit-contain"
                                            ...
                                            <img id="darkLogoImg"
                                                 class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2 object-fit-contain"
                                                 src="{{ getFile($basicControl->dark_logo_driver, $basicControl->dark_logo, true) }}"
                                                 alt="@lang("Dark Logo")" data-hs-theme-appearance="dark">
                                            <span class="d-block mb-3">@lang("Browse your file here")</span>
                                            <input type="file" class="js-file-attach-dark-logo form-check-input"
                                                   name="dark_logo" id="darkLogoUploader"
                                                   data-hs-file-attach-options='{
                                                      "textTarget": "#darkLogoImg",
                                                      "mode": "image",
                                                      "targetAttr": "src",
                                                      "allowTypes": [".png", ".jpeg", ".jpg", ".svg"]
                                                   }'>
...
@push('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            new HSFileAttach('.js-file-attach-dark-logo', {
                textTarget: "#darkLogoImg"
            });
