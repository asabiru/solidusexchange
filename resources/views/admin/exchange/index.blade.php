                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">{{ucfirst($exchangeType)}} @lang("Exchange")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">{{ucfirst($exchangeType)}} @lang("Exchange")</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Pending Exchange")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$exchanges['pendingExchange']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$exchanges['totalExchange']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-warning text-warning p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($exchanges['pendingExchangePercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Complete Exchange")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$exchanges['completeExchange']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$exchanges['totalExchange']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($exchanges['completeExchangePercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Cancel Exchange")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$exchanges['cancelExchange']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$exchanges['totalExchange']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-down"></i> {{$exchanges['cancelExchangePercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-2 mb-md-0">
                            <div class="input-group input-group-merge navbar-input-group">
                                ...
                                <input type="search" id="datatableSearch"
                                       ...
                                       placeholder="@lang('Search Exchange')"
                                       aria-label="@lang('Search Exchange')"
                                       autocomplete="off">
                                                    ...
                                                    <div class="col-sm mb-4">
                                                        ...
                                                        <div class="tom-select-custom">
                                                            <select
                                                                ...
                                                                <option value="1"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-info"></span>Ожидание депозита</span>'>
                                                                </option>
                                                                <option value="2"
...
@push('script')
    <script>
        ...
        $(document).on('click', '.delete_btn', function () {
            ...
            $('#deleteModalBody').text('Are you sure you want to proceed with the deletion of this exchange?');
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.exchangeListSearch").'?type='.$exchangeType }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.exchangeListSearch").'?type='.$exchangeType }}" + "&name=" + name +
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.exchangeMultipleDelete') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
