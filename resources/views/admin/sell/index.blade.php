                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">{{ucfirst($sellType)}} @lang("Sell Crypto")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">{{ucfirst($sellType)}} @lang("Sell Crypto")</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Pending Sell")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$sells['pendingSell']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$sells['totalSell']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-warning text-warning p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($sells['pendingSellPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$sells['completeSell']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$sells['totalSell']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($sells['completeSellPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$sells['cancelSell']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$sells['totalSell']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-down"></i> {{$sells['cancelSellPercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$sells['refundSell']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">from {{$sells['totalSell']??0}}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-primary text-primary p-1">{{fractionNumber($sells['refundSellPercentage'])??0}}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-2 mb-md-0">
                            <div class="input-group input-group-merge navbar-input-group">
                                ...
                                <input type="search" id="datatableSearch"
                                       ...
                                       placeholder="@lang('Search Sell Crypto')"
                                       aria-label="@lang('Search Sell Crypto')"
                                       autocomplete="off">
...
@push('script')
    <script>
        ...
        $(document).on('click', '.delete_btn', function () {
            ...
            $('#deleteModalBody').text('Are you sure you want to proceed with the deletion of this sell crypto?');
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.sellListSearch").'?type='.$sellType }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.sellListSearch").'?type='.$sellType }}" + "&name=" + name +
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.sellMultipleDelete') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
