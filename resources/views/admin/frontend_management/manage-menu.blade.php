                            ...
                            <div
                                ...
                                <div class="list-group-item mb-2">
                                    <div class="d-flex justify-content-between align-items-center drop-content">
                                        ...
                                        @if($page->type == 3)
											<button type="button"
                                                    class="btn btn-ghost-secondary btn-icon btn-sm deleteBtn"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route("admin.add.custom.link") }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <input type="text" class="form-control" id="link" name="link" placeholder="https://" autocomplete="off"
                                   aria-label="https://">
                            @error("link")
                            <span class="invalid-feedback d-block">{{ $message }}</span>
                            @enderror
...
@push('script')
    <script>
        ...
        $(document).on('change', '.drop-pages, .manage-menu-drop', function (event, ui) {
            ...
            $('.manage-menu-drop').find('button').addClass('d-none');
        });
