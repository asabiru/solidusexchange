        ...
        <div class="modal-content">
            ...
            <form action="" method="post" class="setBalanceRoute">
                ...
                <div class="modal-body">
                    <div class="row mb-4">
                        <h5 class="col modal-title"><i class="fal fa-user-group me-2"></i>@lang("Contact Balance")</h5>
                        <div class="col-auto">
                            <span class="text-success user-contact-balance"></span>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <h5 class="col modal-title"><i class="fal fa-mail-bulk me-2"></i>@lang("Email Balance")</h5>
                        <div class="col-auto">
                            <span class="text-success user-email-balance"></span>
                        </div>
                    </div>
                    <label class="form-label" for="exampleFormControlInput1">@lang("Enter Credit")</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="credit" placeholder="@lang("Enter Credit")"
                               value="{{ old("credit") }}"
                               autocomplete="off">
                        <div class="input-group-append">
                            <select class="form-select" name="type">
                                <option value="limit_contact">@lang('Contacts')</option>
                                <option value="limit_emails">@lang('Emails')</option>
                            </select>
                        </div>
                    </div>
                    @error('amount')
