...
@section('content')
    ...
    <!-- Exchange widget with default buy tab -->
    ...
    <div class="dash-exchange-widget">
        @include($theme.'partials.exchange-module.swap-widget', ['defaultTab' => 'buy'])
    </div>

    <!-- History -->
    <div class="dash-exchange-heading">
        <h4>@lang('Buy history')</h4>
    </div>
    <!-- main -->
    <div class="card">
        <div class="card-body">
            <form action="{{route('user.buyList')}}" method="get">
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Send Amount')"><a class="d-flex align-items-center me-2"
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="text-hover-primary mb-0">{{number_format($value->send_amount,2)}} {{optional($value->sendCurrency)->code}}</h5>
                                                <span
                                    ...
                                    <td data-label="@lang('Get Amount')">
                                        <a class="d-flex align-items-center me-2"
                                           href="javascript:void(0)">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="text-hover-primary mb-0">{{rtrim(rtrim($value->final_amount,
                                                    0), '.')}} {{optional($value->getCurrency)->code}}</h5>
                                                <span
                                    ...
                                    <td data-label="@lang('Rate')">
                                        1 {{optional($value->getCurrency)->code}} ~
                                        {{$value->show_exchange_rate}} {{optional($value->sendCurrency)->code}}
                                    </td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{route('user.buyDetails',$value->utr)}}"
    ...
    {{ $buys->appends($_GET)->links($theme.'partials.user.pagination') }}
